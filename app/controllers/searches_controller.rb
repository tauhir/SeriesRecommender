class SearchesController < ApplicationController
  ...
  def has_session
    state = "no_session"
    id = nil
    if cookies[:last_query_time] && Time.now-cookies[:last_query_time].to_i < 12 # this checks to see if the user was on the system in the last 12 hours, maybe should make it less
